...
| `/dashboard` | SCREEN | 0 | 0 | 0 | 0 | 13 | **PASS** |
...
| `/finance/manage-accounts/assign` | SCREEN | 1 | 0 | 6 | 12 | 7 | **PASS** |
...
| `/finance/subheads` | SCREEN | 1 | 0 | 7 | 8 | 7 | **PASS** |
...
| `/payment-vouchers` | SCREEN | 1 | 0 | 10 | 15 | 4 | **PASS** |
...
| `/reports` | SCREEN | 2 | 0 | 3 | 0 | 7 | **PASS** |
| `/reports/enterprise-analytics` | SCREEN | 1 | 0 | 2 | 0 | 0 | **PASS** |
| `/requests` | SCREEN | 1 | 0 | 3 | 0 | 4 | **PASS** |
