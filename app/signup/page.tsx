...
export default function SignupPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-white px-4">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-2xl items-center py-10">
        <div className="w-full rounded-[2rem] border border-slate-200 bg-white p-7 shadow-xl shadow-slate-200/60">
          <div className="flex items-center justify-between gap-5 border-b border-slate-100 pb-5">
            <div>
              <div className="text-xs font-black uppercase tracking-[0.18em] text-blue-700">ReqGen Registration</div>
              <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-950">Create staff account</h1>
              <p className="mt-1 text-sm text-slate-600">Enter your official details to get started.</p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-700 px-4 py-3 text-sm text-white hover:bg-blue-800 disabled:opacity-60 font-black rounded-xl shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed"
              >
