      ...
      <section className="panel no-print">
        ...
        <form onSubmit={postTransfer}>
          ...
          <div className="form-actions">
            <button type="button" className="button button-light" onClick={clearForm} disabled={posting}><span aria-hidden="true">↺</span>Clear Form</button>
            <button type="submit" className="button button-primary" disabled={posting || Boolean(validationMessage)}><span aria-hidden="true">⇄</span>{posting ? "Posting Transfer…" : "Post Transfer"}</button>
          </div>
