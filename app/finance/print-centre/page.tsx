      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_.72fr]">
        ...
        <FinanceCard>
          ...
          <div className="mt-5 grid gap-3">
            <Link href={`/finance/reports?view=output&template=${selected}`} className="inline-flex items-center justify-center gap-2 bg-cyan-700 px-4 py-3 text-sm text-white hover:bg-cyan-800 font-black rounded-xl shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60">👁️ Open Print Workspace</Link>
