      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_.72fr]">
        ...
        <FinanceCard>
          ...
          <div className="mt-5 grid gap-3">
            <Link href={`/finance/reports?view=output&template=${selected}`} className="inline-flex items-center justify-center gap-2 rounded-xl bg-cyan-700 px-4 py-3 text-sm font-black text-white shadow-sm transition hover:bg-cyan-800">👁️ Open Print Workspace</Link>
