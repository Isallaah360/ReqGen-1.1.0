    ...
    <main className="ledger-shell">
      ...
      <section className="control-card no-print">
        ...
        <div className="control-actions">
          <button type="button" className="refresh-button" onClick={() => void loadData(true)} disabled={refreshing}>
            <span aria-hidden="true">↻</span>{refreshing ? "Refreshing…" : "Refresh Ledger"}
          </button>
          <button type="button" className="export-button" onClick={exportCsv} disabled={!selected}>
            <span aria-hidden="true">⇩</span>Export Excel / CSV
          </button>
          <button type="button" className="print-button" onClick={() => window.print()} disabled={!selected}>
