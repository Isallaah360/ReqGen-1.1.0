          ...
          <div className="relative grid gap-7 lg:grid-cols-[1fr_310px] lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3 no-print">
                <button className="reqgen-btn reqgen-btn-blue action secondary" onClick={() => router.push("/finance")}>🏛 Finance Control Centre</button>
                <button className="reqgen-btn reqgen-btn-violet action cyan" onClick={() => router.push("/finance/reports?view=output")}>📊 Reports Centre</button>
              </div>
            </div>
        ...
        <section className="panel-enter mt-5 rounded-[1.7rem] border border-slate-200/80 bg-white/95 p-5 shadow-[0_16px_50px_rgba(15,23,42,.08)] no-print">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            <div className="flex items-end gap-2">
              <button className="reqgen-btn reqgen-btn-rose action cyan w-full" disabled={working} onClick={loadData}>↻ Refresh</button>
            </div>
          </div>
          <div className="mt-4 flex flex-wrap gap-3">
            <button className="reqgen-btn reqgen-btn-rose action blue" disabled={working} onClick={printOnePageReport}>🖨 {working ? "Preparing..." : "Print / Save PDF"}</button>
            <button className="reqgen-btn reqgen-btn-rose action green" disabled={working} onClick={exportExcel}>📗 {working ? "Preparing..." : "Export Standard Excel"}</button>
          </div>
        </section>
