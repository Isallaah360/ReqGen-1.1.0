          ...
          <div className="relative grid gap-7 lg:grid-cols-[1fr_310px] lg:items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3 no-print">
                <button className="action secondary bg-slate-700 hover:bg-slate-800 px-4 py-2.5 font-black text-white rounded-xl shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60" onClick={() => router.push("/finance")}>🏛 Finance Control Centre</button>
                <button className="action cyan bg-slate-700 hover:bg-slate-800 px-4 py-2.5 font-black text-white rounded-xl shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60" onClick={() => router.push("/finance/reports?view=output")}>📊 Reports Centre</button>
              </div>
            </div>
        ...
        <section className="panel-enter mt-5 rounded-[1.7rem] border border-slate-200/80 bg-white/95 p-5 shadow-[0_16px_50px_rgba(15,23,42,.08)] no-print">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            <div className="flex items-end gap-2">
              <button className="action cyan w-full bg-slate-700 hover:bg-slate-800 px-4 py-2.5 font-black text-white rounded-xl shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60" disabled={working} onClick={loadData}>↻ Refresh</button>
            </div>
          </div>
          <div className="mt-4 flex flex-wrap gap-3">
            <button className="action blue bg-slate-700 hover:bg-slate-800 px-4 py-2.5 font-black text-white rounded-xl shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60" disabled={working} onClick={printOnePageReport}>🖨 {working ? "Preparing..." : "Print / Save PDF"}</button>
            <button className="action green bg-slate-700 hover:bg-slate-800 px-4 py-2.5 font-black text-white rounded-xl shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60" disabled={working} onClick={exportExcel}>📗 {working ? "Preparing..." : "Export Standard Excel"}</button>
          </div>
        </section>
