...
export default function ReportsCentrePage() {
  ...
  const [tab, setTab] = useState<Tab>("overview"); const [chartDetail, setChartDetail] = useState<string | null>(null); const [dateFrom, setDateFrom] = useState(yearStart); const [dateTo, setDateTo] = useState(today); const [department, setDepartment] = useState("all"); const [status, setStatus] = useState("all");
