...
export default function EnterpriseAnalyticsPage() {
  ...
  return <EnterpriseShell><div className="mx-auto max-w-[1500px] space-y-6">
    <EnterpriseHero eyebrow="ReqGen Decision Intelligence" title="Enterprise Analytics Centre" description="Cross-module, role-aware operational intelligence. Every query remains governed by the current active role and Supabase RLS." actions={<ActionButton tone="cyan" onClick={() => void load()}>{loading ? "Refreshing..." : "Refresh Analytics"}</ActionButton>} />
