...
import { HRAccessState, HRPageHero, HRRecordTable, HRSearchBox, HRStatCard, categoryKey, isArchived, isCompleted, isRejected, stageKey, useFilteredRows, useHRRequests } from "@/app/components/hr/HRWorkspace";
