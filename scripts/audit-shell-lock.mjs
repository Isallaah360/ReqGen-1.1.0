...
const requiredNav = ["Command Centre", "Dashboard", "Requests", "Approvals", "Finance", "Payment Vouchers", "Registry", "Reports", "Audit Centre", "Workflow", "Admin", "Profile"];
...
if (!css.includes('.rg-subnav a{font-size:12px!important')) failures.push("Collapsible navigation typography lock (12px) is missing.");
...
console.log("Main navigation: 13px; collapsible navigation: 12px; PV create link removed from collapsible menu.");
