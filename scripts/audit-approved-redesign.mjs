...
const sections=['payment-vouchers','registry','reports','audit-centre','admin'];
...
// PV navigation was intentionally consolidated (see Phase 7/8 audits) into
// three sidebar entries: the unified Centre workspace, Manual Voucher
// creation, and Settings. new/pending/approved/print-centre/history are
// views inside the Centre workspace, not separate top-level nav items.
const pvNav=['/payment-vouchers','/payment-vouchers/manual','/payment-vouchers/settings'];
